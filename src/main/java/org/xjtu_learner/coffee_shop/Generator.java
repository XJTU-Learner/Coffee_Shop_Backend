...
public class Generator {
    public static void main(String[] args) {
        FastAutoGenerator.create("jdbc:mysql://rm-cn-36z47skf5000638o.rwlb.rds.aliyuncs.com:3306/coffee_shop", "zhxue", "Xzh040305") // jdbc连接
                ...
                .strategyConfig(builder -> {
                    builder.addInclude("tb_merchant_restock_record")
                            .addTablePrefix("tb_")
                            .entityBuilder()
