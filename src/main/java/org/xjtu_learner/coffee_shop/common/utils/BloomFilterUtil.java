...
public class BloomFilterUtil {
    ...
    public static final String BLOOMFILTER_COUPONS = "COUPONS";
    public static final Integer BLOOMFILTER_COUPONS_SIZE = 500;
    public static final Float BLOOMFILTER_COUPONS_FPP = 0.01F;
